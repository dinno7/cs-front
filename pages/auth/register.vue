...
import type { UserInfoRegistration } from '~/utils/types';
import { NOTIFICATION_TYPES } from '~/utils/types'

// >> Defines
definePageMeta({
  middleware: async function (meta) {
...
<template>
  <div class="min-h-[calc(100vh-4rem)] flex dark:bg-gray-900">
    <div class="hidden lg:block relative w-0 flex-1">
      <img class="absolute inset-0 h-full w-full object-cover object-left" src="~/assets/images/auth/register.jpg"
        alt="" />
    </div>
    <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24 lg:basis-1/2">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div class="mt-8">
          <div>
            <!-- <div>
              <p class="text-sm font-medium text-gray-50">ورود با اکانت</p>
            ...
            <div class="mt-6 relative">
              ...
              <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-gray-900 text-gray-100 ">ثبت نام با ایمیل</span>
              </div>
            </div>
          </div>
