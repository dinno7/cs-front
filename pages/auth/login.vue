...
import type { UserInfoLogin } from "~/utils/types";
...
<template>
  <div class="min-h-[calc(100vh-4rem)] flex dark:bg-gray-900">
          ...
          <div>
            ...
            <div class="mt-6 relative">
              ...
              <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-gray-900 text-gray-100 ">ورود با ایمیل</span>
              </div>
            </div>
          </div>
    ...
    <div class="hidden lg:block relative w-0 flex-1">
      <img class="absolute inset-0 h-full w-full object-cover object-right" src="~/assets/images/auth/login.jpg" alt="" />
    </div>
  </div>
</template>